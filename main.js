...
function GenerateCV() {
    ...
    document.getElementById('gitT').innerHTML = `<a href="${gitFeild}" target="_blank"><img src="github.png" alt=""></a>`;
    document.getElementById('linkT').innerHTML = `<a href="${linkedinFeild}" target="_blank" ><img src="linked.png" alt=""></a>`;
